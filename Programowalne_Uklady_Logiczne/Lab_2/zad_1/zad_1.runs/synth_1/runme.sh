...
HD_PWD='F:/Studia/PUL/Lab_2/zad_1/zad_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zad_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zad_1.tcl
